...
public class FileController {
	...
	public FileController(ServletContext context) {
		// 상대 경로
		String relativePath = "resources/upload/file";
		// 절대 경로 
		absolutePath = context.getRealPath(relativePath);
	}
	
	// 컨트롤러에서 넘겨받은 multipartFile multi 파라미터
	public PhotoDTO proUpload(MultipartFile multi) {
