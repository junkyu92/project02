...
<!-- 우측 상단 div (bgm/도토리/검색) -->
	...
	<div id="frame">
		...
		<!-- 우측 페이지 -->
		<div id="mainRight">
				<form action="diaryPageUpdateAction">
				제목:<input type=text name="title" value="${diarypageone.title}"><br>
				내용:<input type=text name="content" value="${diarypageone.content}"><br>
				<input type=hidden name="pageid" value="${diarypageone.id}"><br>
				<input type=hidden name="memid" value="${sessionId}"><br>
				<input type=hidden name="bookid" value ="<%=request.getParameter("bookid")%>"><br>
				<button>수정</button>
				</form>
